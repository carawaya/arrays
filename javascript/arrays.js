// create an array
var colors = ["Red", "Black", "White", "Blue", "ocher", "Yellow", "Pink"];
...
imageListA[14] = "images/drawing/thumbs/artwork_14.jpg";
...
{
      //hook onto thumbs div
      var thumbsDiv = document.getElementById("thumbs");
      //create output variable
      var output = "";
  
  //first part is counter, start at 0 for loop
  // second part is the condition, loop will iterate while condition is true
  // incrementer, adds 1 to the counter after the code has been executed in the brackets 
